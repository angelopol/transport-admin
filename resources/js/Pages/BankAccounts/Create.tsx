...
export default function Create({ auth }: PageProps) {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Agregar Cuenta Bancaria</h2>}>
            <Head title="Agregar Cuenta Bancaria" />
