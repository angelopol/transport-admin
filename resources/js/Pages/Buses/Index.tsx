...
export default function Index({ buses, isAdmin }: Props) {
    const [selectedBusForPoster, setSelectedBusForPoster] = useState<PaymentPosterBus | null>(null);
    ...
    const getCalculatedFare = (baseFare: number, value?: number, isPercentage?: boolean): number => {
    ...
    return (
        ...
        >
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {buses.data.map((bus) => (
                                        <tr key={bus.id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 text-gray-600">{bus.collectors?.map(c => c.name).join(', ') || '—'}</td>
                                            <td className="px-6 py-4">
                                ...
                                <div key={bus.id} className="p-4 border-b border-gray-200 last:border-b-0 space-y-3">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                        ...
                                        <div className="col-span-2">
                                            <span className="block text-xs font-semibold text-gray-500 uppercase">Colectores</span>
            ...
            <PaymentPosterModal bus={selectedBusForPoster} onClose={() => setSelectedBusForPoster(null)} />
