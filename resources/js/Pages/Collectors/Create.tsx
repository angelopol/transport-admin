                ...
                <div className="mx-auto max-w-xl px-4 sm:px-6 lg:px-8">
                    <div className="bg-white rounded-xl shadow-lg p-6">
                        <form onSubmit={submit} className="space-y-6" autoComplete="off">
                            <h2 className="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-3">Nuevo Colector</h2>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        name="user_email_random" // random name to confuse autofill
                                        required
                                    />
