...
return [
    ...
    */
    ...
    'gte' => [
        ...
        'string' => 'El campo :attribute debe ser como mínimo de :value caracteres.',
    ],
    ...
    'lte' => [
        ...
        'string' => 'El campo :attribute debe ser como máximo de :value caracteres.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se utilizan para intercambiar nuestros marcadores
    | de posición de atributos con algo más fácil de leer, como "Dirección de Correo" en
    | lugar de "email". Esto simplemente nos ayuda a hacer nuestros mensajes más expresivos.
    |
    */
